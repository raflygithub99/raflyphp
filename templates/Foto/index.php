                    ...
                    <div class="card-footer">
                        <div class="ml-auto">
                            ...
                            <?php if ($userLiked): ?>
                                ...
                                <div class="card-footer">
                                <?= $this->Form->postLink(__('Unlike'), ['controller'=>'Likefoto', 'action' =>'delete', $userLiked->id], ['confirm' => __('Are you sure you want to unlike this photo?'), 'class' => 'btn btn-danger']) ?>
                            </div>
                            <?= $this->Form->end() ?>
                            <?php else: ?>
                                <?= $this->Form->create(null, ['url' => ['controller'=>'Likefoto', 'action' =>'add'],'role'=>'form']) ?>
                                    <div class="card-footer">
                                        ...
                                        <?= $this->Form->button(('like'), ['class' => 'btn btn-primary']) ?>
                                    </div>
                                <?= $this->Form->end() ?>
                            <?php endif; ?>
                            </td>
                        ...
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $fotoItem->id], ['class' => 'btn btn-primary']) ?>
